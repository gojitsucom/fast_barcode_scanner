...
struct OCRData: Hashable {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ pigeonVar_list: [Any?]) -> OCRData? {
    let text = pigeonVar_list[0] as! String
    let cornerPoints: [PointData?]? = nilOrValue(pigeonVar_list[1])
  ...
  static func == (lhs: OCRData, rhs: OCRData) -> Bool {
    return deepEqualsBarcodeApi(lhs.toList(), rhs.toList())  }
  func hash(into hasher: inout Hasher) {
    deepHashBarcodeApi(value: toList(), hasher: &hasher)
  }
...
///
/// Generated class from Pigeon that represents data sent in messages.
struct ScanData: Hashable {
  var barcodes: [BarcodeData?]? = nil
  var ocrData: [OCRData?]? = nil


  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ pigeonVar_list: [Any?]) -> ScanData? {
    let barcodes: [BarcodeData?]? = nilOrValue(pigeonVar_list[0])
    let ocrData: [OCRData?]? = nilOrValue(pigeonVar_list[1])
...
struct ScannerConfiguration: Hashable {
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> ScannerConfiguration? {
    ...
    let enableOcr = pigeonVar_list[7] as! Bool
...
struct UpdateConfiguration: Hashable {
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> UpdateConfiguration? {
    ...
    let enableOcr: Bool? = nilOrValue(pigeonVar_list[5])
...
private class BarcodeApiPigeonCodecReader: FlutterStandardReader {
  override func readValue(ofType type: UInt8) -> Any? {
    ...
    case 138:
      return OCRData.fromList(self.readValue() as! [Any?])
    case 139:
...
private class BarcodeApiPigeonCodecWriter: FlutterStandardWriter {
  override func writeValue(_ value: Any) {
    if let value = value as? BarcodeType {
      ...
      super.writeByte(137)
      super.writeValue(value.toList())
    } else if let value = value as? OCRData {
      super.writeByte(138)
      super.writeValue(value.toList())
...
protocol FastBarcodeScannerHostApi {
  ...
  func scanImage(imageSource: ImageSourceData, completion: @escaping (Result<ScanData, Error>) -> Void)
...
protocol FastBarcodeScannerFlutterApiProtocol {
  ...
  func onScanDataDetected(scanData scanDataArg: ScanData, completion: @escaping (Result<Void, PigeonError>) -> Void)
...
class FastBarcodeScannerFlutterApi: FastBarcodeScannerFlutterApiProtocol {
  ...
  /// Called when scan data (barcodes and/or OCR) is detected
  func onScanDataDetected(scanData scanDataArg: ScanData, completion: @escaping (Result<Void, PigeonError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.fast_barcode_scanner_platform_interface.FastBarcodeScannerFlutterApi.onScanDataDetected\(messageChannelSuffix)"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage([scanDataArg] as [Any?]) { response in

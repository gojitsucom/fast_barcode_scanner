...
class OCRData {
  ...
  static OCRData decode(Object result) {
    result as List<Object?>;
    return OCRData(
      text: result[0]! as String,
      cornerPoints: (result[1] as List<Object?>?)?.cast<PointData?>(),
  ...
  // ignore: avoid_equals_and_hash_code_on_mutable_classes
  bool operator ==(Object other) {
    if (other is! OCRData || other.runtimeType != runtimeType) {
      return false;
    }
    if (identical(this, other)) {
      return true;
...
class ScanData {
  ...
  static ScanData decode(Object result) {
    result as List<Object?>;
    return ScanData(
      barcodes: (result[0] as List<Object?>?)?.cast<BarcodeData?>(),
      ocrData: (result[1] as List<Object?>?)?.cast<OCRData?>(),
    );
  }
  ...
  // ignore: avoid_equals_and_hash_code_on_mutable_classes
  bool operator ==(Object other) {
    if (other is! ScanData || other.runtimeType != runtimeType) {
      return false;
    }
    if (identical(this, other)) {
      return true;
...
class ImageSourceData {
  ...
  static ImageSourceData decode(Object result) {
    ...
    return ImageSourceData(
      ...
      useImagePicker: result[2]! as bool,
    );
  }
  ...
  // ignore: avoid_equals_and_hash_code_on_mutable_classes
  bool operator ==(Object other) {
    if (other is! ImageSourceData || other.runtimeType != runtimeType) {
      return false;
    }
    if (identical(this, other)) {
      return true;
...
class _PigeonCodec extends StandardMessageCodec {
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      ...
      case 138: 
        return OCRData.decode(readValue(buffer)!);
      case 139: 
...
class FastBarcodeScannerHostApi {
  ...
  Future<ScanData> scanImage(ImageSourceData imageSource) async {
    ...
    if (pigeonVar_replyList == null) {
      ...
      return (pigeonVar_replyList[0] as ScanData?)!;
    }
  }
...
abstract class FastBarcodeScannerFlutterApi {
  ...
  static void setUp(FastBarcodeScannerFlutterApi? api, {BinaryMessenger? binaryMessenger, String messageChannelSuffix = '',}) {
    ...
    {
      final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.fast_barcode_scanner_platform_interface.FastBarcodeScannerFlutterApi.onScanDataDetected$messageChannelSuffix', pigeonChannelCodec,
      ...
      if (api == null) {
        ...
        pigeonVar_channel.setMessageHandler((Object? message) async {
          assert(message != null,
          'Argument for dev.flutter.pigeon.fast_barcode_scanner_platform_interface.FastBarcodeScannerFlutterApi.onScanDataDetected was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final ScanData? arg_scanData = (args[0] as ScanData?);
          assert(arg_scanData != null,
              'Argument for dev.flutter.pigeon.fast_barcode_scanner_platform_interface.FastBarcodeScannerFlutterApi.onScanDataDetected was null, expected non-null ScanData.');
          try {
            api.onScanDataDetected(arg_scanData!);
    ...
    }
    {
      ...
      if (api == null) {
        ...
        pigeonVar_channel.setMessageHandler((Object? message) async {
          assert(message != null,
          'Argument for dev.flutter.pigeon.fast_barcode_scanner_platform_interface.FastBarcodeScannerFlutterApi.onError was null.');
          final List<Object?> args = (message as List<Object?>?)!;
